        ...
        <CardsContainer data-aos="fade-up">
          <CardsWrapper>
            <ul className="cards__items">
              <TopPicksItems
                src="https://i.postimg.cc/507grk1Y/Turkish-1.jpg"
                text="Fine Variety of Turkish Rugs and more...."
                label="Turkish Rugs"
                to="/products"
              />
              <TopPicksItems
                src="https://i.postimg.cc/Fs2WmqS0/Jhelum.jpg"
                text="Explore ourCollection of Jhelum Carpets."
                label="Jhelum Carpets"
                to="/products"
              />
              <TopPicksItems
                src="https://i.postimg.cc/Jn4KPWwC/20.png"
                text="Beautiful Collection of Viscose Carpets..."
                label="Viscose Carpet"
                to="/products"
              />
            </ul>
          </CardsWrapper>
